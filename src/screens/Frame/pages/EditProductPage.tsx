...
export const EditProductPage = (): JSX.Element => {
  ...
  const breadcrumbItems = [
    ...
    { label: "изменить товар", active: true, path: null },
  ];
  ...
  return (
    <div className="flex min-h-screen bg-[#101011]">
      ...
      <main className="flex flex-col flex-1 min-w-0">
        <header className="flex flex-col gap-2.5 px-4 lg:px-8 py-6 bg-[#1a1a1b] border-b border-[#3d3d3d]">
              ...
              {breadcrumbItems.map((item, index) => (
                <React.Fragment key={index}>
                  <div
                    ...
                    className={`text-sm [font-family:'PPNeueMachina-Regular',Helvetica] ${
                      item.active 
                        ? "text-[#09b9d9]" 
          ...
          <div className="flex flex-col lg:flex-row items-start gap-[22px] w-full">
            ...
            <Card className="w-full lg:w-[600px] bg-[#1a1a1b] rounded-3xl border border-solid border-[#3d3d3d]">
              <CardContent className="flex flex-col gap-4 p-6">
                <h2 className="text-[#f6f6f6] text-[22px] [font-family:'PPNeueMachina-Regular',Helvetica]">
                ...
                <div className="flex flex-col gap-4 w-full">
                  ...
                  <div className="flex flex-col items-start gap-1.5 w-full">
                      ...
                      <Input
                        placeholder="Boeing 773 (Rossiya)"
                        className="h-[52px] px-4 py-2 w-full border-[1.6px] border-solid border-[#d1d1d1] rounded-xl bg-transparent [font-family:'PPNeueMachina-Regular',Helvetica] font-normal text-neutral-500 text-sm tracking-[0] leading-[21px]"
                      />
                  </div>
                  {/* Размер и Цвет */}
                  ...
                  <div className="flex flex-col lg:flex-row gap-4">
                    <div className="flex flex-col items-start gap-1.5 flex-1">
                        ...
                        <Select defaultValue="boeing">
                          <SelectTrigger className="h-[52px] px-4 py-2 w-full border-[1.6px] border-solid border-[#d1d1d1] rounded-xl bg-transparent [font-family:'PPNeueMachina-Regular',Helvetica] font-normal text-neutral-500 text-sm tracking-[0] leading-[21px]">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                  ...
                  <div className="flex flex-col items-start gap-1.5 w-full">
                      ...
                      <Select defaultValue="sale">
                        <SelectTrigger className="h-[52px] px-4 py-2 w-full border-[1.6px] border-solid rounded-xl bg-transparent [font-family:'PPNeueMachina-Regular',Helvetica] font-normal text-neutral-500 text-sm tracking-[0] leading-[21px]">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="sale">В продаже</SelectItem>
            ...
            {/* Правая часть — картинки и кнопки */}
            <div className="flex flex-col gap-6 w-full lg:flex-1">
              ...
              <Button variant="outline" className="flex justify-center gap-2.5 h-auto px-6 py-3 w-full lg:flex-1 hover:bg-[#f0f0f0] [font-family:'PPNeueMachina-Regular',Helvetica] rounded-xl">
                Удалить изменения
              </Button>
