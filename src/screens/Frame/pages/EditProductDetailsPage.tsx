...
const sidebarMenuItems = [
  ...
  { icon: StoreIcon, label: "Товары", active: true, hasSubmenu: true },
  { icon: FileTextIcon, label: "Заказы  (441)", active: false },
  { icon: UsersIcon, label: "Клиенты", active: false },
];
...
export const EditProductDetailsPage = (): JSX.Element => {
  ...
  const breadcrumbItems = [
    ...
    { label: "информация", active: true, path: null },
  ];
          ...
          <div className="flex flex-col lg:flex-row items-start gap-[22px] w-full">
                ...
                <div className="flex flex-col items-start gap-4 w-full">
                  <div className="flex flex-col items-start gap-1.5 w-full">
                    ...
                    <Input
                      defaultValue="123151"
                      disabled
                      className="h-[52px] px-4 py-2 w-full border-[1.6px] border-solid border-[#d1d1d1] rounded-xl bg-transparent text-[#f6f6f6] [font-family:'PPNeueMachina-Regular',Helvetica] font-normal text-sm tracking-[0] leading-[21px]"
                    />
                  </div>
                  ...
                  <div className="flex flex-col items-start gap-1.5 w-full">
                    ...
                    <Input
                      defaultValue="Boeing 773 (Rossiya)"
                      disabled
                      className="h-[52px] px-4 py-2 w-full border-[1.6px] border-solid border-[#d1d1d1] rounded-xl bg-transparent text-[#f6f6f6] [font-family:'PPNeueMachina-Regular',Helvetica] font-normal text-sm tracking-[0] leading-[21px]"
                    />
                  </div>
                  ...
                  <div className="flex flex-col items-start gap-1.5 w-full">
                    ...
                    <Input
                      defaultValue="Улица Пушкина дом ...."
                      disabled
                      className="h-[52px] px-4 py-2 w-full border-[1.6px] border-solid border-[#d1d1d1] rounded-xl bg-transparent text-[#f6f6f6] [font-family:'PPNeueMachina-Regular',Helvetica] font-normal text-sm tracking-[0] leading-[21px]"
                    />
                  </div>
            ...
            <div className="flex flex-col items-start gap-6 w-full lg:flex-1">
              ...
              <div className="flex items-start justify-end gap-1 w-full">
                <Button 
                  onClick={() => navigate("/orders")}
                  className="flex justify-center gap-2.5 h-auto px-6 py-3 w-full lg:flex-1 bg-[#ffffff] rounded-xl hover:bg-[#f0f0f0] transition-colors [font-family:'PPNeueMachina-Regular',Helvetica]"
                >
                  <span className="font-normal text-black text-sm text-center tracking-[0] leading-[21px] whitespace-nowrap">
                    Обратно к заказам
                  </span>
                </Button>
              </div>
